...
p_getFiles : function(dirPath, options,fileName) {
    ...
    return new Promise((resolve,reject)=>{
        ...
        this.p_wiLog(dirPath)
        this.p_wiLog(fileName)
        ...
        fs.readdir(dirPath, function(err, q) {
            ...
            this.p_wiLog('The readdir results q')
            this.p_wiLog(q)
