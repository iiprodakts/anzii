...
export const handleRequestHandOver = function (data) {
    ...
    if (handler && handler.trim() !== '') {
        ...
        self.requestData = { parsed: parsed, handler: handler, request: { req: data.req, res: data.res, next: data.next } };
        ...
        if (self.isView(data.req.originalUrl, uza))
            return self.emit({ type: `do-view-task`, data: { payload: self.requestData, callback: self.taskerHandler.bind(self),
                } });
