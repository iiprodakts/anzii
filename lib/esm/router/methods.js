...
export const outOfRouterContext = function(req,res){

	const self = this 
	let data = {error: true,type:"NotFound",code:404,message:'Resource was not found'}
	self.emit({type: 'write-server-request-response',data: {data: data,res: res}})

}

export const handOver = function(req,res){
