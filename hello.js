class Hello {
    ...
    handleHelloTask(data) {
        ...
        self.getSavedHistory().then((saved) => {
    ...
    getSavedHistory() {
        return new Promise((resolve, reject) => {
            ...
            self.query('mysql.SEARCH', queries, self.multiDataRequestHandler.bind(this, resolve, reject));
        });
    }
    multiDataRequestHandler(resolve = null, reject = null, e = null, result = null) {
        const self = this;
        let pao = self.pao;
        self.pao.pa_wiLog('THE TYPE OF E IN DATAREQUEST HANDLER');
        self.pao.pa_wiLog(e);
        if (e)
            reject(new Error('An error has occured Inside MYSQL'));
        resolve(result);
    }
}
